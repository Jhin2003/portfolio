...
const projectsData = [
  {
    ...
    shortDesc:
      "A specialized conversational AI utilizing RAG architecture to answer questions about Philippine cultural history and heritage.",
    fullDesc:
      "QUBO is an advanced chatbot designed to preserve and educate users on Philippine cultural history. It leverages a Retrieval-Augmented Generation (RAG) pipeline with semantic chunking and optimized embedding models to deliver highly accurate, context-aware responses. The system was rigorously tested through a multi-stage evaluation process, utilizing an 'LLM-as-a-Judge' framework to ensure the reliability and quality of its historical information.",
    image: "/QUBO.png",
    tags: ["Python", "FastAPI", "RAG", "React", "LLM Evaluation"],
    link: "https://example.com/qubo",
    github: "https://github.com/Jhin2003/Qubo",
  },
  {
    id: 2,
    title: "FSLEARN",
    shortDesc:
      "An interactive Filipino Sign Language (FSL) recognition app that uses computer vision to translate signs into text in real-time.",
    fullDesc:
      "FSLEARN is designed to bridge the communication gap by translating Filipino Sign Language (FSL) gestures into text in real-time. Utilizing a custom PyTorch-based computer vision model, the application accurately tracks hand movements and spatial gestures. The system features a responsive React frontend for seamless user interaction, powered by a highly optimized FastAPI backend to handle low-latency video stream processing and model inference.",
    image: "https://picsum.photos/seed/fslearn/800/450?blur=2",
    tags: ["Python", "PyTorch", "OpenCV", "FastAPI", "React"],
    link: "https://example.com/fslearn",
  ...
  },
  {
    ...
    title: "Gray Merchant",
    shortDesc:
      "A full-stack e-commerce platform designed for buying, selling, and trading collectible card game (CCG) singles and sealed products.",
    fullDesc:
      "Gray Merchant is a dedicated digital storefront tailored for the trading card community. It features a comprehensive inventory management system, dynamic pricing integration, and a streamlined cart and checkout process. The application pairs a responsive React frontend with a high-performance FastAPI backend, utilizing Supabase for secure user authentication and real-time database management to facilitate smooth buy-and-sell transactions.",
    image: "/Gray2.png",
    tags: ["React", "FastAPI", "Supabase", "PostgreSQL"],
    link: "https://example.com/gray-merchant",
    github: "https://github.com/Jhin2003/gray-merchant",
  },
];
        ...
        <section id="experience" className="py-24 border-t border-white/5">
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] glass-card p-6 rounded-2xl">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">
                Developed a full-stack e-commerce platform for trading card game
                collectors. Integrated comprehensive inventory management,
                dynamic pricing, and secure Supabase authentication to
                facilitate smooth buy-and-sell transactions.
              </p>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] glass-card p-6 rounded-2xl opacity-80 hover:opacity-100 transition-opacity">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">
                Engineered the myDoktora mobile platform. Focused on
                implementing secure passkey authentication, complex onboarding
                workflows, and an efficient waitlist registration system for
